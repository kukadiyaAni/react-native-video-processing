...
export class Trimmer extends Component {
  ...
  _handleRightCornerMove(e, gestureState) {
    ...
    if(e.nativeEvent.pageX > layoutWidth ){
      return
    }
  ...
  _handleLeftCornerMove(e, gestureState) {
    ...
    console.log("leftPos,rightPos,moveRight", leftPos, this._rightCornerPos, moveRight);
  ...
  renderRightSection() {
    ...
    return (
      <Animated.View
        style={[styles.container, styles.rightCorner, { right: -layoutWidth , }, {
          transform: [{
  ...
  render() {
    ...
    return (
      <View
        style={[styles.container,{overflow:'hidden',borderRadius:10}]}
